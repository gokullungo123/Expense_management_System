...
const getMonthlyTransactionsByUser = async (email, month) => {
    return await axios.get(
        API_BASE_URL + '/report/getMonthlyTransactionsByUser', 
        {
            headers: AuthService.authHeader(), 
            params: {
                email: email,
...
const addGoal = (email, goalName, price, targetDate) => {
    return axios.post(
        API_BASE_URL + '/goals/addGoal',
        {
            userEmail: email,
            goalName: goalName,
            price: price,
...
const getGoals = (email) => {
    return axios.get(
        API_BASE_URL + '/goals/all',
        {
            headers: AuthService.authHeader(),
            params: { email: email }
        }
...
const updateGoal = (userEmail, goalId, goalName, price, targetDate, amountSaved) => {
    return axios.put(
        API_BASE_URL + '/goals/update',
        {
            userEmail: userEmail,
            goalName: goalName,
            price: price,
