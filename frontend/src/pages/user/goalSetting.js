    ...
    <Container activeNavId={12}>
      ...
      <div className="goal-setting-container">
        ...
        <div className="goal-input">
          ...
          <input type="date" value={goalDate} onChange={(e) => setGoalDate(e.target.value)} className="goal-input-field" min={new Date().toISOString().split("T")[0]} style={{cursor: "pointer"}} />
        ...
        <ul className="goal-list">
          {goalList && goalList.length > 0 ? (goalList.map((goal, index) => (
