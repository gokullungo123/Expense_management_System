        ...
        await AuthService.login_req(data.email, data.password).then(
            ...
            (error) => {
                ...
                if (resMessage === "Bad credentials"){
                    ...
                    setResponseError("Your account has been disabled by the admin. Please contact support for further assistance.");
                }
            }
          );
        setIsLoading(false);
    ...
    return(
        <div className='container' style={{alignContent : 'center'}}>
            ...
            <Logo/>
                ...
                <br/><div className='msg'>Don't have account? <Link to='/auth/register' className='inline-link'>Register Here</Link></div>
            </form>
        </div>
    )
}
