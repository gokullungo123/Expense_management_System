        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body(
                    new ApiResponseDto<>(
                            ...
                            HttpStatus.OK,
                            new PageResponseDto<>(userResponseDtoList, users.getTotalPages(),
    ...
    private UserResponseDto userToUserResponseDto(User user) {
        return new UserResponseDto(
                ...
                transactionRepository.findTotalByUserAndTransactionType(
                        user.getId(),
                        transactionTypeRepository.findByTransactionTypeName(ETransactionType.TYPE_EXPENSE)
                                .getTransactionTypeId(),
                        LocalDate.now().getMonthValue(),
                        LocalDate.now().getYear()),
                transactionRepository.findTotalByUserAndTransactionType(
                        user.getId(),
                        transactionTypeRepository.findByTransactionTypeName(ETransactionType.TYPE_INCOME)
                                .getTransactionTypeId(),
                        LocalDate.now().getMonthValue(),
                        LocalDate.now().getYear()),
