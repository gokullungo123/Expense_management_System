...
public class EmailNotificationService implements NotificationService {
        ...
        public void sendNewGoalNotificationEmail(User user, GoalSetting goalSetting)
                ...
                String content = "<html>" +
                                ...
                                "                    <p><strong>Completion Date:</strong> " + formattedCompletionDate
                                + "</p>" +
                                "                </div>" +
        ...
        public void sendGoalCompletionNotificationEmail(User user, GoalSetting goalSetting)
                ...
                String content = "<html>" +
                                ...
                                "                <div class='goal-details'>" +
                                "                    <p><strong>Goal Name:</strong> " + goalSetting.getName() + "</p>" +
                                "                    <p><strong>Target Amount:</strong> " + goalSetting.getPrice()
                                + "</p>" +
                                "                    <p><strong>Amount Saved:</strong> " + goalSetting.getAmountSaved()
                                + "</p>" +
                                "                    <p><strong>Target Date:</strong> " + goalSetting.getTargetDate()
                                + "</p>" +
