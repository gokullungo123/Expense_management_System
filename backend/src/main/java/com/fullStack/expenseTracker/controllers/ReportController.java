...
@RestController
@RequestMapping("/expensetracker/report")
public class ReportController {
    ...
    @GetMapping("/getMonthlyTransactionsByUser")
    @PreAuthorize(("hasRole('ROLE_USER')"))
    public ResponseEntity<ApiResponseDto<?>> getMonthlyTransactionsByUser(@Param("email") String email, @Param("month") int month) {
        return reportService.findMonthlyTransactionsByUser(email, month);
    }
